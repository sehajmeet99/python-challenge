...
# Set path for file
csvpath = os.path.join("/Users/sehaj/Downloads/Starter_Code 22/PyBank/Resources", "budget_data.csv")
...
output_path = os.path.join("/Users/sehaj/Downloads/Starter_Code 22/PyBank/analysis", "results.txt")
