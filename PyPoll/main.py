...
# Set path for file
csvpath = os.path.join("/Users/sehaj/Downloads/Starter_Code 22/PyPoll/Resources", "election_data.csv")
...
output_path = os.path.join("/Users/sehaj/Downloads/Starter_Code 22/PyPoll/analysis", "results.txt")
